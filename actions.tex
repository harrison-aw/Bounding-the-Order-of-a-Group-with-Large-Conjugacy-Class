...
Equivalently, transitive actions are those that, for all $\alpha, \beta \in \Omega$, there exists a $g \in G$ such that $ \alpha \cdot g = \beta$. This view is perhaps more suggestive but, in our results, the former definition will prove more immediately useful.
...
\begin{lemma}
Let $G$ be a finite group and $H < G$. Let $x \in N_G(H)$, then $\generate{x}$ acts transitively on $H$.
\end{lemma}
