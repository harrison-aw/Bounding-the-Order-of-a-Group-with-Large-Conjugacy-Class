...
We now discuss the conjugacy class structure of dihedral groups. The number and sizes of conjugacy classes is completely determined by the order of a dihedral group. In the following propositions, let $D$ be a dihedral group and $C \normal D$ be cyclic of index 2.
